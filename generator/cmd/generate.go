...
func main() {
  ...
  packages := []schemagen.PackageDescriptor{
    ...
    {"github.com/kudobuilder/kudo/pkg/apis/kudo/v1beta1", "kudo.dev", "io.fabric8.kudo.apis.v1beta1", "kudo_api_v1beta1_"},
    {"github.com/kudobuilder/kudo/pkg/kudoctl/packages", "kudo.dev", "io.fabric8.kudo.kudoctl.packages", "kudo_packages_"},
  }
